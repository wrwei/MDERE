...
\begin{figure}
	\centering
	\includegraphics[width=1\linewidth]{fig/basicGSN.eps}
...
\begin{figure}
	\centering
	\includegraphics[width=0.5\linewidth]{fig/gsnConnectors.eps}
	\caption{Core GSN Elements}
	\label{fig:gsnEdges}
\end{figure}
...
\begin{figure}
	\centering
	\includegraphics[width=1\linewidth]{fig/GSNExample.jpg}
...
\begin{figure}
	\centering
	\includegraphics[width=0.9\linewidth]{fig/ModularGSN.eps}
...
\begin{figure}
	\centering
	\includegraphics[width=1\linewidth]{fig/gsnPattern.eps}
	\caption{An example goal structure}
...
\begin{figure}[ht!]
	\centering
	\includegraphics[width=1\linewidth]{fig/DMILSPattern.pdf}
