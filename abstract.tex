...
In addition, to promote a model based approach, we provide a SACM compliant metamodel for the Goal Structuring Notation (GSN) and the transformation between GSN and SACM.
